...
#    Then the user enters an email address "abc.com"
#    Then the user enters a phone number "xyz"
#    Then the user should see "Error:Enter your full name" error message for "name"
#    Then the user should see "Error:Enter an email address in the correct format, like name@example.com" error message for "email"
