...
Feature: Customs check - Export journey
  ...
  Scenario Outline: A user wants to complete an Export RouteOne journey
    ...
    Then the user clicks the button to add another document
    When the user clicks the button to upload the sixth file and selects the "doc" file
    Then the user clicks the button to add another document
    ...
    Then the user clicks the button to add another document
    When the user clicks the button to upload the ninth file and selects the "docx" file
    Then the user clicks the button to add another document
    ...
    Examples:
      ...
      | 050 | K77899X | Withdrawal       | Route 2 | Human remains | RoadRoRoRail | TestVessel    | smith | aa_kaygcc@test.com | 0177 111 1111 |
  ...
  Scenario Outline: A user wants to complete a New Import journey
    ...
    Examples:
      | epu | entryNo | requestType  | route   | priority      | transport | transportName | name  | email            | phone       |
      | 565 | 800416L | Cancellation | Route 1 | Human remains | Maritime  | train 1x      | agent | valid@test.co.uk | 01256888999 |
