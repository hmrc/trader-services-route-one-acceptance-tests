...
#    Then the user clicks MFU continue
    ...
    Examples:
      ...
      | 003 | O88899X | C1601         | Route 2 | Human remains | RoadRoRoRail  | TestVessel    | smith | aa_kaygcc@test.com | 0177 111 1111 |
...
#    Then the user waits 50000
  ...
  Scenario Outline: A user wants to complete a New Import journey
    ...
    Examples:
      | epu | entryNo | requestType | route   | priority      | transport | transportName | name  | email            | phone       |
      | 551 | 000416L | New         | Hold | Human remains | Maritime       | train 1x      | agent | valid@test.co.uk | 01256888999 |
